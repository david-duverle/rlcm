...
void PROBLEM_print (LCM_PROBLEM *P);

/*****  print usage of the program *****/
void PROBLEM_error ();

/*****  read parameters given by command line  *****/
void PROBLEM_read_param (int argc, char *argv[], LCM_PROBLEM *P);
...
void PROBLEM_alloc (LCM_PROBLEM *PP, QUEUE_ID siz, QUEUE_ID siz2, size_t siz3, PERM *p, int f);

/* termination of problem */
void PROBLEM_end (LCM_PROBLEM *PP);
